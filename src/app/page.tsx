...
export default function HomePage() {
  return (
    <div className="text-light">
      {/* Hero */}
      <section className="py-5 border-bottom border-danger">
        <h1 className="display-4 fw-bold text-warning">NEVER HALFWAY</h1>
        <p className="lead fst-italic">"They ask why I didn’t quit. I ask what quitting even looks like."</p>
      </section>
          ...
          <div className="col">
            <div className="card h-100 border-danger">
              <div className="card-body">
                ...
                <p className="card-text">Refactored legacy C++ tooling to modern, efficient structures. Built for resilience, not trends.</p>
          ...
          <div className="col">
            <div className="card h-100 border-danger">
              <div className="card-body">
                ...
                <p className="card-text">Doom EP produced entirely in Drop A, with sonar swells and ambient noise inspired by planetary collapse.</p>
                <a href="#" className="btn btn-primary">Listen</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-4">
        ...
        <p>
          No forms. No bullshit. Just email: <a href="mailto:bill@neverhalfway.dev" className="text-warning">bill@neverhalfway.dev</a>
        </p>
      </section>

      {/* Footer */}
      <footer className="pt-4 mt-4 border-top border-danger text-center small text-secondary">
        Built by Bill Zade — Veteran. Builder. Musician. Coder. <span className="text-warning">NEVER HALFWAY.</span>
      </footer>
    </div>
  );
}
